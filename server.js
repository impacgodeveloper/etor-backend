...
// ── CORS ─────────────────────────────────────────────────────
// Allow ALL origins. We reflect whatever Origin header the request
// sent (via `callback(null, true)`) rather than a literal '*',
// because a literal '*' is invalid when combined with
// `credentials: true` — browsers will reject that combination.
app.use(cors({
